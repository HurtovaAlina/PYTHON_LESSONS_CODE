...
print(f"Payment per person for {persons} persons for common bill including tips {bill_with_tips:.2f}$: "
...
print(f"Cost of rent after deposit refund: {cost_of_rent_excl_dep:.2f}$ "

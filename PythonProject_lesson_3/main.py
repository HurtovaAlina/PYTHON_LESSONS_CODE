...
print(int(7), int(2.56), int(False), int(True), int("7"))
print(str(7), str(2.56), str(False), str(True), str("7")+"7")
print(float("13")+7, float(2.56), float(False), float(True), float("7"))
print(bool("13")+7, bool(2.56), bool(False), bool(True), bool("7"))
print(bool("")+7, bool(0.0), bool(False), bool(True), bool(""))
